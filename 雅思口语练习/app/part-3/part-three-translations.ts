export type PartThreeTranslation = { question: string; answer: string };
...
export const partThreeTranslations: Record<string, PartThreeTranslation> = {
  ...
  "What is the difference between encouraging someone and pressuring someone?": {
  ...
  "Why do you think some children seem to have more imagination than others?": {
  ...
  "What are the benefits of travelling by bicycle compared to by car?": {
  ...
  "Do you think everyone has the same taste in music? Why/Why not?": {
    question: "你认为每个人对音乐的品味都一样吗？为什么/为什么不？",
    answer: "不会。音乐品味受年龄、文化、个性和个人记忆的影响。年轻人可能喜欢新的流行音乐，而老年人可能更喜欢年轻时的歌曲。",
  },
  "What kind of music is suitable for big public events, like sports games or celebrations?": {
    question: "什么样的音乐适合大型公共活动，例如体育比赛或庆祝活动？",
    answer: "欢快、熟悉的音乐通常效果很好，因为它能创造能量，而且很多人都能享受它。音量不应该太大，组织者应该考虑观众。",
  },
  "How important is music in creating the atmosphere at a social event?": {
    question: "音乐对于营造社交活动的氛围有多重要？",
    answer: "音乐相当重要，因为它影响人们的情绪并填补令人不舒服的沉默。快节奏的音乐可以让庆祝活动热闹起来，而轻柔的音乐则适合用餐或交谈。",
  },
  "Do you think older people and younger people enjoy the same kind of music at events? What are the differences?": {
    question: "您认为老年人和年轻人在活动中喜欢同样的音乐吗？有什么区别？",
    answer: "有一些重叠，但年轻人通常更喜欢当前的流行音乐或电子音乐，而老年人可能喜欢熟悉的老歌曲。在混合年龄的活动中，组织者可以发挥多种风格。",
  },
  "How has technology (like streaming apps) changed the way people listen to music at parties or events?": {
    question: "技术（如流媒体应用程序）如何改变人们在聚会或活动中听音乐的方式？",
    answer: "流媒体应用程序使组织者可以访问庞大的音乐库和现成的播放列表。客人还可以立即点歌。",
  },
  "Do you think live music at events will be replaced by recorded music in the future? Why or why not?": {
  ...
  "What are the benefits of living in a foreign country for a short time?": {
    question: "短期生活在异国他乡有什么好处？",
    answer: "人们可以练习一种语言，了解另一种文化并变得更加独立。短期停留还可以让他们获得国际工作或学习经验，而无需永久搬迁。",
  },
  "What problems might people have when they stay in a foreign country?": {
    question: "人们在异国他乡时可能会遇到哪些问题？",
    answer: "语言困难、不熟悉的食物和不同的规则都会造成压力。人们还可能感到孤独或难以找到住房和医疗保健。",
  },
  "Is it better to travel alone or with friends when visiting another country? Why?": {
  ...
  "How do advertisements influence people’s spending habits?": {
    question: "广告如何影响人们的消费习惯？",
    answer: "广告将产品与幸福、成功或吸引力联系起来，这可以创造情感需求。在线平台还反复展示个性化广告。",
  },
  "What can people do to avoid overspending?": {
  ...
  "Do you think traditional stories (like fairy tales) are still relevant for children today?": {
    question: "您认为传统故事（如童话故事）对今天的孩子来说仍然有意义吗？",
    answer: "是的。传统故事讨论勇气、善良、贪婪和责任，这些仍然具有现实意义。成年人可能需要解释老式的想法或可怕的部分。",
  },
  "How can stories influence a person‘s character or values?": {
